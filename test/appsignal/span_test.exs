defmodule AppsignalSpanTest do
  ...
  describe ".trace_id/1" do
    test "returns an ok-tuple with the trace_id as a list", %{span: %Span{reference: reference}} do
  ...
  describe ".span_id/1" do
    test "returns an ok-tuple with the span_id as a list", %{span: %Span{reference: reference}} do
