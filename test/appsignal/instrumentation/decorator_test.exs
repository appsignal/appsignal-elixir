...
defmodule Appsignal.Instrumentation.DecoratorsTest do
  ...
  test_with_mock "instrument module function", Appsignal.Transaction, [:passthrough], [] do
    ...
    assert called(
             Transaction.finish_event(t, "bar", "Elixir.UsingAppsignalDecorators.bar", "", 0)
           )
    ...
    assert called(
             Transaction.finish_event(
               t,
               "nested",
               "Elixir.UsingAppsignalDecorators.nested",
               "",
               0
             )
           )
  ...
  test_with_mock "instrument transaction", Appsignal.Transaction, [:passthrough], [] do
    ...
    assert called(
             Appsignal.Transaction.set_action(:_, "Elixir.UsingAppsignalDecorators#transaction")
           )
  ...
  test_with_mock "instrument background transaction", Appsignal.Transaction, [:passthrough], [] do
    ...
    assert called(
             Appsignal.Transaction.set_action(
               :_,
               "Elixir.UsingAppsignalDecorators#background_transaction"
             )
           )
  ...
  test_with_mock "instrument transaction with return value",
    ...
    assert called(
             Appsignal.Transaction.set_action(
               :_,
               "Elixir.UsingAppsignalDecorators#transaction_with_return_value"
             )
           )
  ...
  test_with_mock "instrument module function with category",
                 Appsignal.Transaction,
                 [:passthrough],
                 [] do
    t = Transaction.start("bar", :http_request)
    ...
    assert called(
             Transaction.finish_event(
               t,
               "bar.http",
               "Elixir.UsingAppsignalDecoratorsWithCustomNamespaces.bar",
               "",
               0
             )
           )
    ...
    assert called(
             Transaction.finish_event(
               t,
               "nested.db",
               "Elixir.UsingAppsignalDecoratorsWithCustomNamespaces.nested",
               "",
               0
             )
           )
